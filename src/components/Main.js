...
//获取图片相关信息 var imageDatas = require('../data/imageDatas.json');
...
var GalleryByReactApp = React.createClass({
    ...
    getInitialState: function () {
        return {
            imgsArrangeArr: [
                // { 	pos: { 		left: '0', 		top: '0' 	}, 	rotate: 0,         //旋转角度 	isInverse:
                // false,  //图片正反面(正面) 	isCenter: false    //图片是否居中(不居中) }
            ]
        };
    },
    ...
    componentDidMount: function () {
        //首先拿到舞台的大小 var stageDOM = ReactDOM.findDOMNode(this.refs.stage),
        ...
        // 拿到imgFigure的大小 var imgFigureDOM = ReactDOM.findDOMNode(this.refs.imgFigure0),
    ...
    render: function () {
        ...
        return (
            <section className="stage" ref="stage" style={style}>
